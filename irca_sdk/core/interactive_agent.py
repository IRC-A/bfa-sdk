...
class IRCAInteractiveAgent(IRCAAgent):
    """
    An extension of IRCAAgent for frontend/coordinator agents that need memory and context management.
    """
...
BFAInteractiveAgent = IRCAInteractiveAgent
